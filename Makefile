...
.PHONY: all run test core-test bridge-test workspace-test sanitized-test lua-test desktop clean check-lua
...
test: core-test bridge-test workspace-test lua-test
